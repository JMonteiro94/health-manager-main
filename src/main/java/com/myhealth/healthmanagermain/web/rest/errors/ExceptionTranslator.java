...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
  ...
  @ExceptionHandler
  public ResponseEntity<Problem> handleBadRequestAlertException(BadRequestApiException ex,
      NativeWebRequest request) {
    return create(ex, request);
  }
  ...
  @Override
  public ProblemBuilder prepare(final @NonNull Throwable throwable,
      final @NonNull StatusType status,
      final @NonNull URI type) {
  ...
  private boolean containsPackageName(String message) {
    return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.",
        "com.myhealth.healthmanagermain");
  }
}
