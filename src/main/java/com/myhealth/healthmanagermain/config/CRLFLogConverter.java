...
public class CRLFLogConverter extends CompositeConverter<ILoggingEvent> {
  ...
  static {
    ELEMENTS = Map.of("faint", AnsiStyle.FAINT, "red", AnsiColor.RED, "green", AnsiColor.GREEN,
        "yellow", AnsiColor.YELLOW, "blue", AnsiColor.BLUE, "magenta", AnsiColor.MAGENTA, "cyan",
        AnsiColor.CYAN);
  }
  ...
  protected String transform(ILoggingEvent event, String in) {
    ...
    if ((event.getMarker() != null && event.getMarker().contains(CRLF_SAFE_MARKER)) || isLoggerSafe(
        event)) {
      return in;
    }
